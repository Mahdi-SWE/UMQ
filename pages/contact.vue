    ...
    <div class="px-40 flex flex-1 justify-center py-5">
        <div class="layout-content-container flex flex-col max-w-[960px] flex-1">
            <div class="flex flex-wrap justify-between gap-3 p-4">
                <p class="text-[#0e101b] tracking-light text-[32px] font-bold leading-tight min-w-72">Contact us</p>
            </div>
            <h3 class="text-[#0e101b] text-lg font-bold leading-tight tracking-[-0.015em] px-4 pb-2 pt-4">Customer
                Service</h3>
            <div class="flex items-center gap-4 bg-[#f8f9fc] px-4 min-h-[72px] py-2">
                <div class="text-[#0e101b] flex items-center justify-center rounded-lg bg-[#e7e9f3] shrink-0 size-12"
                    data-icon="Clock" data-size="24px" data-weight="regular">
            ...
            <div class="flex items-center gap-4 bg-[#f8f9fc] px-4 min-h-14">
                <div class="text-[#0e101b] flex items-center justify-center rounded-lg bg-[#e7e9f3] shrink-0 size-10"
                    data-icon="EnvelopeOpen" data-size="24px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor"
                        viewBox="0 0 256 256">
                        <path
